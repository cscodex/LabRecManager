...
import {
    ...
    Save, Eye, EyeOff, RefreshCw, Trash2, AlertTriangle
} from 'lucide-react';
            ...
            <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="flex items-center justify-between py-2">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Show results to students right after submission</p>
                            </div>
                            <button
                        ...
                        <div className="flex items-center justify-between py-2">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Capture student photo before starting exam</p>
                            </div>
                            <button
                    ...
                    <div className="p-4 space-y-4">
                        <div className="flex items-center justify-between py-2">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Let students create their own accounts</p>
                            </div>
                            <button
                ...
                <div className="bg-white rounded-xl shadow-sm">
                    <div className="p-4 border-b flex items-center gap-2">
                        ...
                        <h2 className="font-semibold text-gray-900">System Maintenance</h2>
                    </div>
                    <div className="p-4 space-y-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="font-medium text-gray-900">Clear Cache</p>
                                <p className="text-sm text-gray-500">Clear application cache to free up memory</p>
                            </div>
                            <button
                    ...
                    <div className="bg-white rounded-xl shadow-sm border-2 border-red-200">
                        ...
                        {showDangerZone && (
                            <div className="p-4 border-t space-y-4 bg-red-50">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="font-medium text-gray-900">Reset All Exam Data</p>
                                        <p className="text-sm text-red-600">This will delete all exam attempts. Cannot be undone!</p>
                                    </div>
                                    <button
                                        onClick={() => {
                                            if (confirm('Are you ABSOLUTELY sure? This cannot be undone!')) {
                                                toast.success('Feature disabled for safety');
                                            }
                                        }}
