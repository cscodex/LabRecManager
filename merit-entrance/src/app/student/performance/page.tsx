                                                ...
                                                if (active && payload && payload.length > 0) {
                                                    ...
                                                    return (
                                                        <div className="bg-white rounded-lg shadow-lg border border-gray-100 p-3">
                                                            <p className="font-semibold text-gray-900"><MathText text={data.name} inline /></p>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center justify-between mb-2">
                                                    <span className="font-semibold text-gray-900 truncate">
                                                        <MathText text={getText(item.name, language)} inline />
                                                    </span>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                        ...
                        <ul className="space-y-2 text-sm text-gray-700">
                            {performanceData.length > 0 && performanceData[performanceData.length - 1].percentage < 50 && (
                                <li>• Focus more on <strong><MathText text={getText(performanceData[performanceData.length - 1].name, language)} inline /></strong> - it&apos;s your weakest area</li>
                            )}
